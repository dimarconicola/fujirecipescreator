...
11. `npm run calibration:camera:run`
12. `npm run calibration:camera:baseline:check`
13. `npm run calibration:camera:baseline:lock`
14. `npm run calibration:camera:baseline:refresh`
15. `npm run calibration:camera:gate`
...
6. `artifacts/calibration/oracle-camera-engine-v1/index.v1.json` (generated by camera import script)
